<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Write.aspx.cs" Inherits="Project001.Board.Write" %>
    ...
    <table>
        ...
        <tr>
            ...
            <td style="width: 430px; background-color: #B8DEFF;">&nbsp; <asp:ImageButton ID="ImageButton1" runat="server" 
                    ImageUrl="~/images/btn_write.PNG" onclick="ImageButton1_Click" Height="35px" Width="80px" /> &nbsp; 
