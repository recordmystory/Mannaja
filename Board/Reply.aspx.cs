...
namespace Project001.Board
{
    public partial class Reply : System.Web.UI.Page
    {
        ...
        protected void ImageButton1_Click(object sender, ImageClickEventArgs e)
        {
            ...
            string sql2 = @"Update board01 Set inner_id = inner_id + 1
Where ref_id = @ref_id and inner_id > @inner_id";
            ...
            string sql3 = @"Insert into board01(name, pwd, title, body, ref_id, inner_id, depth, wDate, fName, fSize)
	Values (@name,@pwd,@title,@body,@ref_id,@inner_id,@depth, getDate( ), @fName, @fSize);";
